/*
  ...
  - You are about to drop the column `inmgestEventId` on the `Execution` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Execution_inmgestEventId_key";

-- AlterTable
ALTER TABLE "Execution" DROP COLUMN "inmgestEventId",
